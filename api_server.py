...
class ProcessingService:
    ...
    async def enhance_image_cloud(
        ...
        #         f"{self.cloud_endpoints['inference']}/enhance",
...
async def enhance_image(
    ...
    if processing_mode == "local":
        ...
        result_data = await processing_service.enhance_image_cloud(image_data, params)
        img_mode = None
    ...
    try:
        ...
        try:
            if params.processing_mode == "local":
                ...
                result_data = await processing_service.enhance_image_cloud(
